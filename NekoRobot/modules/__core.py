# Copyright (C) 2022 NekoRobot
# made by @Horimaya on Telegram.
# github account : https://github.com/Hodacka/
...
from NekoRobot.events import register as Asuna
...
async def send(event):
    ...
    the_plugin_file = "./NekoRobot/modules/{}.py".format(input_str)
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "NekoRobot/modules/",  # pylint:disable=E0602
                )
            )
